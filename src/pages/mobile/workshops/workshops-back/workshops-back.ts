...
/**
* Generated class for the WorkshopsBackPage page.
*
...
@IonicPage({
  name: 'WorkshopsBackPage',
  segment: 'workshops/back-end',
  defaultHistory: ['WorkshopsPage']
})
@Component({
  selector: 'page-workshops-back',
  templateUrl: 'workshops-back.html',
})
export class WorkshopsBackPage {
