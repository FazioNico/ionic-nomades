...
/**
* Generated class for the WorkshopsFrontPage page.
*
...
@IonicPage({
  name: 'WorkshopsFrontPage',
  segment: 'workshops/front-end',
  defaultHistory: ['WorkshopsPage']
})
@Component({
  selector: 'page-workshops-front',
  templateUrl: 'workshops-front.html',
})
export class WorkshopsFrontPage {
